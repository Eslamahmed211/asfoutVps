...
<body>
    ...
    <form action="/login" method="post">
        ...
        <div class="my-2">
            ...
            <p class="text-xs">
                <span>لا تمتلك حسابا بعد؟</span>
                <a  href="/register" class="font-bold primary-text-color">التسجيل</a>
            </p>

            <p class="text-xs mt-2">
                <span>نسيت كلمة مرورك؟</span>
                <a href="/reset_password" class="font-bold primary-text-color">استعادة</a>
            </p>
